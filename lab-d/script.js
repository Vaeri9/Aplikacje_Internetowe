...
const WeatherApp = class {
    constructor(apiKey, resultsBlockSelector) {
        ...
        this.currentWeatherLink = `http://api.openweathermap.org/data/2.5/weather?q={query}&appid=${apiKey}&units=metric`;
        this.forecastLink = `http://api.openweathermap.org/data/2.5/forecast?q={query}&appid=${apiKey}&units=metric`;
...
document.weatherApp = new WeatherApp("cc3226c76c8a31144a7ca830094bc5ba", '#weather-results-container');
